...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/BibliographieTesteur.o ${TESTDIR}/_ext/da6dbd92/JournalTesteur.o ${TESTDIR}/_ext/da6dbd92/OuvrageTesteur.o ${TESTDIR}/_ext/da6dbd92/ReferenceTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -lgtest -lgtest_main -lpthread 


${TESTDIR}/tests/BibliographieTesteur.o: tests/BibliographieTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -include /usr/src/gtest/include/gtest/gtest.h -include /usr/src/gtest/test/googletest-param-test-test.h -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BibliographieTesteur.o tests/BibliographieTesteur.cpp


${TESTDIR}/_ext/da6dbd92/JournalTesteur.o: ../../TP3_Franck/sources/JournalTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/da6dbd92
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -include /usr/src/gtest/include/gtest/gtest.h -include /usr/src/gtest/test/googletest-param-test-test.h -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/da6dbd92/JournalTesteur.o ../../TP3_Franck/sources/JournalTesteur.cpp


${TESTDIR}/_ext/da6dbd92/OuvrageTesteur.o: ../../TP3_Franck/sources/OuvrageTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/da6dbd92
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -include /usr/src/gtest/include/gtest/gtest.h -include /usr/src/gtest/test/googletest-param-test-test.h -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/da6dbd92/OuvrageTesteur.o ../../TP3_Franck/sources/OuvrageTesteur.cpp


${TESTDIR}/_ext/da6dbd92/ReferenceTesteur.o: ../../TP3_Franck/sources/ReferenceTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/da6dbd92
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -include /usr/src/gtest/include/gtest/gtest.h -include /usr/src/gtest/test/googletest-param-test-test.h -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/da6dbd92/ReferenceTesteur.o ../../TP3_Franck/sources/ReferenceTesteur.cpp
