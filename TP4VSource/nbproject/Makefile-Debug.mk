...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtp4vsource.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtp4vsource.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtp4vsource.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtp4vsource.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtp4vsource.a
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/BibliographieTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/BibliographieTesteur.o: BibliographieTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/BibliographieTesteur.o BibliographieTesteur.cpp
